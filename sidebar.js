...
(function() {
    const renderSidebar = () => {
        const sidebarHTML = `
        <aside class="w-64 bg-white border-r border-gray-100 flex flex-col fixed h-full z- font-sans">
            ...
            <div class="p-4 border-t border-gray-50">
                <div id="btn-perfil-acesso" 
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-[13px] font-black text-gray-800 truncate" id="sidebar-user-name">Dr. Victor</
