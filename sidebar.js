...
document.addEventListener("DOMContentLoaded", function() {
    const sidebarHTML = `
    <aside class="w-64 bg-white border-r border-gray-100 flex flex-col fixed h-full z-50 font-sans">
        ...
        <div class="p-4 border-t border-gray-50">
            <div id="btn-perfil-acesso" onclick="window.location.href='perfil.html'" 
    ...
    // Sincronização de Dados (Nome, Foto e Categoria)
